Rails.application.configure do
  ...
  config.action_mailer.asset_host = 'http://rogikhub.herokuapp.com/'
  config.action_mailer.default_options = {
    from: 'hello@rogikhub.herokuapp.com'
  }
  config.action_mailer.default_url_options = { host: 'rogikhub.herokuapp.com' }
